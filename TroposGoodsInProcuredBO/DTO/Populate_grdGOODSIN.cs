...
namespace TroposGoodsInProcuredBO.DTO
{
    public class Populate_grdGOODSIN : ITroposQuery
    {
        ...
        public string SQLStatement
        {
            ...
            {
                string SQL = @"
                            SELECT  A.PORDQTY, B.PORDER_SCH, B.PORDITM_SCH, A.PARTNO_PORD, C.DESCRIPTION, round(A.PORDREC) PORDREC, TO_CHAR(B.POSCHREQD, 'DD-MON-YY') ReqDate,  D.STOR, D.BINLOCN, E.GRNUMBER, A.UOM_PURCH, (A.PORDQTY - A.PORDREC) OUTSTANDING_QTY, TO_CHAR(SYSDATE, 'DD-MON-YY') TODAY
